...
// node_modules/@nomana-it/liberty-core/dist/index.es-D6oC0jBA.mjs
function on(n2, e, r, t, i, a, s) {
  try {
...
function Z() {
  ...
  n2(typeof globalThis == "object" && globalThis) || n2(typeof window == "object" && window) || // eslint-disable-next-line no-restricted-globals -- safe
  n2(typeof self == "object" && self) || n2(typeof kn == "object" && kn) || n2(typeof lr == "object" && lr) || // eslint-disable-next-line no-new-func -- fallback
  /* @__PURE__ */ function() {
    return this;
...
function rl() {
  if (Nn) return mt;
  Nn = 1;
  var n2 = er(), e = te(), r = Ir(), t = el(), i = Object;
...
function ne() {
  if (Gn) return It;
  Gn = 1;
  var n2 = Z(), e = Ga(), r = we(), t = tl(), i = Ju(), a = el(), s = n2.Symbol, o = e("wks"), u = a ? s.for || s : s && s.withoutSetter || t;
...
function zl() {
  if (zn) return Nt;
  zn = 1;
  var n2 = se(), e = Ce(), r = rl(), t = ar(), i = Gl(), a = ne(), s = TypeError, o = a("toPrimitive");
...
function qr() {
  if (Yn) return Qr;
  Yn = 1;
  var n2 = Ee(), e = se(), r = Ul(), t = Ba(), i = cr(), a = il(), s = we(), o = al(), u = Object.getOwnPropertyDescriptor;
...
function $e() {
  if (Qn) return Dt;
  Qn = 1;
  var n2 = Ee(), e = al(), r = nl(), t = ue(), i = il(), a = TypeError, s = Object.defineProperty, o = Object.getOwnPropertyDescriptor, u = "enumerable", l = "configurable", h = "writable";
...
function Vr() {
  if (as) return Ht;
  as = 1;
  var n2 = Hl(), e = Z(), r = Ce(), t = gr(), i = we(), a = Ua(), s = Ha(), o = $a(), u = "Object already initialized", l = e.TypeError, h = e.WeakMap, c, v, f, g = function(m) {
    return f(m) ? v(m) : c(m, {});
  }, d = function(m) {
    return function(b) {
      var x;
...
function sl() {
  ...
  ns = 1;
  var n2 = re(), e = ee(), r = te(), t = we(), i = Ee(), a = Dr().CONFIGURABLE, s = za(), o = Vr(), u = o.enforce, l = o.get, h = String, c = Object.defineProperty, v = n2("".slice), f = n2("".replace), g = n2([].join), d = i && !e(function() {
    return c(function() {
...
function ol() {
  if (cs) return Jt;
  cs = 1;
  var n2 = cr(), e = Wl(), r = Wa(), t = function(i) {
...
function ul() {
  if (vs) return ei;
  vs = 1;
  var n2 = re(), e = we(), r = cr(), t = ol().indexOf, i = $a(), a = n2([].push);
...
function Yl() {
  if (ds) return Wt;
  ds = 1;
  var n2 = ul(), e = Ya(), r = e.concat("length", "prototype");
...
function Kl() {
  if (ys) return ii;
  ys = 1;
  var n2 = er(), e = re(), r = Yl(), t = Xl(), i = ue(), a = e([].concat);
...
function le() {
  if (xs) return si;
  xs = 1;
  var n2 = Z(), e = qr().f, r = gr(), t = rr(), i = Fa(), a = Ql(), s = ll();
...
function eh() {
  if (Rs) return fi;
  Rs = 1;
  var n2 = Jl(), e = String, r = TypeError;
...
function Br() {
  if (ws) return vi;
  ws = 1;
  var n2 = $e().f, e = we(), r = ne(), t = r("toStringTag");
...
function th() {
  if (As) return di;
  As = 1;
  var n2 = er(), e = rh(), r = ne(), t = Ee(), i = r("species");
...
function Xa() {
  if (_s) return mi;
  _s = 1;
  var n2 = ah(), e = te(), r = Ze(), t = ne(), i = t("toStringTag"), a = Object, s = r(/* @__PURE__ */ function() {
    return arguments;
...
function nh() {
  if (Ms) return bi;
  Ms = 1;
  var n2 = re(), e = ee(), r = te(), t = Xa(), i = er(), a = za(), s = function() {
...
function cl() {
  if (Ds) return Ti;
  Ds = 1;
  var n2 = ue(), e = sh(), r = Je(), t = ne(), i = t("species");
...
function vl() {
  ...
  return Oi = typeof Reflect == "object" && Reflect.apply || (n2 ? t.bind(r) : function() {
...
function Ka() {
  if (ks) return Ei;
  ks = 1;
  var n2 = jr(), e = je(), r = Ar(), t = n2(n2.bind);
...
function pl() {
  if (Gs) return Ai;
  Gs = 1;
  var n2 = Z(), e = vl(), r = Ka(), t = te(), i = we(), a = ee(), s = gl(), o = oh(), u = Mr(), l = uh(), h = dl(), c = kr(), v = n2.setImmediate, f = n2.clearImmediate, g = n2.process, d = n2.Dispatch, p = n2.Function, y = n2.MessageChannel, m = n2.String, b = 0, x = {}, S = "onreadystatechange", E, T, _, V;
  a(function() {
    E = n2.location;
  });
  var P = function(R) {
  ...
  return (!v || !f) && (v = function(A) {
    ...
    d.now(M(R));
  } : y && !h ? (_ = new y(), V = _.port2, _.port1.onmessage = w, T = r(V.postMessage, V)) : n2.addEventListener && t(n2.postMessage) && !n2.importScripts && E && E.protocol !== "file:" && !a(k) ? (T = k, n2.addEventListener("message", w, false)) : S in u("script") ? T = function(R) {
...
function ch() {
  if (Ys) return qi;
  Ys = 1;
  var n2 = Z(), e = lh(), r = Ka(), t = pl().set, i = yl(), a = dl(), s = hh(), o = fh(), u = kr(), l = n2.MutationObserver || n2.WebKitMutationObserver, h = n2.document, c = n2.process, v = n2.Promise, f = e("queueMicrotask"), g, d, p, y, m;
  if (!f) {
...
function pr() {
  if (Zs) return ki;
  Zs = 1;
  var n2 = Z(), e = dr(), r = te(), t = ll(), i = za(), a = ne(), s = hl(), o = Me(), u = ja(), l = e && e.prototype, h = a("species"), c = false, v = r(n2.PromiseRejectionEvent), f = t("Promise", function() {
...
function yr() {
  if (Js) return Bi;
  Js = 1;
  var n2 = je(), e = TypeError, r = function(t) {
    var i, a;
...
function gh() {
  if (eo) return ln;
  eo = 1;
  var n2 = le(), e = Me(), r = kr(), t = Z(), i = se(), a = rr(), s = fl(), o = Br(), u = th(), l = je(), h = te(), c = Ce(), v = ih(), f = cl(), g = pl().set, d = ch(), p = vh(), y = Qa(), m = yl(), b = Vr(), x = dr(), S = pr(), E = yr(), T = "Promise", _ = S.CONSTRUCTOR, V = S.REJECTION_EVENT, P = S.SUBCLASSING, M = b.getterFor(T), w = b.set, k = x && x.prototype, R = x, A = k, U = t.TypeError, I = t.document, B = t.process, N = E.f, L = N, j = !!(I && I.createEvent && t.dispatchEvent), H = "unhandledrejection", X = "rejectionhandled", $ = 0, Q = 1, Fe = 2, De = 1, Ae = 2, de, pe, ye, Ie, Ne = function(C) {
    var q;
    return c(C) && h(q = C.then) ? q : false;
  }, he = function(C, q) {
    var G = q.value, z = q.state === Q, W = z ? C.ok : C.fail, _e = C.resolve, Ve = C.reject, xe = C.domain, Te, We, ur;
    try {
      W ? (z || (q.rejection === Ae && Tr(q), q.rejection = De), W === true ? Te = G : (xe && xe.enter(), Te = W(G), xe && (xe.exit(), ur = true)), Te === C.promise ? Ve(new U("Promise-chain cycle")) : (We = Ne(Te)) ? i(We, Te, _e, Ve) : _e(Te)) : Ve(G);
    } catch (Or) {
      xe && !ur && xe.exit(), Ve(Or);
    }
  }, me = function(C, q) {
    ...
    var z, W;
    j ? (z = I.createEvent("Event"), z.promise = q, z.reason = G, z.initEvent(C, false, true), t.dispatchEvent(z)) : z = { promise: q, reason: G }, !V && (W = t["on" + C]) ? W(z) : C === H && p("Unhandled promise rejection", G);
  }, xr = function(C) {
    i(g, t, function() {
      var q = C.facade, G = C.value, z = or(C), W;
      if (z && (W = y(function() {
        r ? B.emit("unhandledRejection", G, q) : Ue(H, q, G);
  ...
  if (_ && (R = function(q) {
    ...
    return z.parent = true, W.ok = h(q) ? q : true, W.fail = h(G) && G, W.domain = r ? B.domain : void 0, z.state === $ ? z.reactions.add(W) : d(function() {
      he(W, z);
    }), W.promise;
  }), pe = function() {
    var C = new de(), q = M(C);
  ...
  return n2({ global: true, constructor: true, wrap: true, forced: _ }, {
    Promise: R
  }), o(R, T, false, true), u(T), ln;
}
var ro = {};
var ji;
var to;
...
function ph() {
  if (no) return Gi;
  no = 1;
  var n2 = se(), e = je(), r = ue(), t = Nr(), i = ml(), a = TypeError;
...
function bl() {
  if (oo) return Hi;
  oo = 1;
  var n2 = Ka(), e = se(), r = ue(), t = Nr(), i = dh(), a = Wa(), s = Ir(), o = ph(), u = ml(), l = yh(), h = TypeError, c = function(f, g) {
    this.stopped = f, this.result = g;
  }, v = c.prototype;
  return Hi = function(f, g, d) {
    var p = d && d.that, y = !!(d && d.AS_ENTRIES), m = !!(d && d.IS_RECORD), b = !!(d && d.IS_ITERATOR), x = !!(d && d.INTERRUPTED), S = n2(g, p), E, T, _, V, P, M, w, k = function(A) {
...
function xl() {
  if (lo) return Wi;
  lo = 1;
  var n2 = dr(), e = mh(), r = pr().CONSTRUCTOR;
...
function bh() {
  if (ho) return ro;
  ho = 1;
  var n2 = le(), e = se(), r = je(), t = yr(), i = Qa(), a = bl(), s = xl();
  return n2({ target: "Promise", stat: true, forced: s }, {
    all: function(u) {
...
function xh() {
  ...
  if (n2({ target: "Promise", proto: true, forced: r, real: true }, {
    catch: function(l) {
...
function Oh() {
  ...
  return n2({ target: "Promise", stat: true, forced: r }, {
    reject: function(i) {
...
function Eh() {
  if (xo) return mo;
  xo = 1;
  var n2 = le(), e = er(), r = Me(), t = dr(), i = pr().CONSTRUCTOR, a = Sh(), s = e("Promise"), o = r && !i;
  return n2({ target: "Promise", stat: true, forced: r || i }, {
    resolve: function(l) {
...
var To;
function Rh() {
  return To || (To = 1, gh(), bh(), xh(), Th(), Oh(), Eh()), un;
}
Rh();
var Oo = {};
var So = {};
...
function wh() {
  if (Po) return Zi;
  Po = 1;
  var n2 = Ee(), e = nl(), r = $e(), t = ue(), i = cr(), a = Ch();
...
function Fr() {
  if (Ao) return ea;
  Ao = 1;
  var n2 = ue(), e = wh(), r = Ya(), t = $a(), i = gl(), a = Mr(), s = Ha(), o = ">", u = "<", l = "prototype", h = "script", c = s("IE_PROTO"), v = function() {
  }, f = function(m) {
...
function Za() {
  if (_o) return ia;
  _o = 1;
  var n2 = se(), e = re(), r = qe(), t = Tl(), i = Ol(), a = Ga(), s = Fr(), o = Vr().get, u = Ph(), l = Ah(), h = a("native-string-replace", String.prototype.replace), c = RegExp.prototype.exec, v = c, f = e("".charAt), g = e("".indexOf), d = e("".replace), p = e("".slice), y = function() {
    var S = /a/, E = /b*/g;
  ...
  return x && (v = function(E) {
    ...
    if (P)
      return P.lastIndex = T.lastIndex, M = n2(v, P, V), T.lastIndex = P.lastIndex, M;
    var B = _.groups, N = m && T.sticky, L = n2(t, T), j = T.source, H = 0, X = V;
    if (N && (L = d(L, "y", ""), g(L, "g") === -1 && (L += "g"), X = p(V, T.lastIndex), T.lastIndex > 0 && (!T.multiline || T.multiline && f(V, T.lastIndex - 1) !== `
`) && (j = "(?: " + j + ")", X = " " + X, H++), w = new RegExp("^(?:" + j + ")", L)), b && (w = new RegExp("^" + j + "$(?!\\s)", L)), y && (k = T.lastIndex), R = n2(c, N ? w : T, X), N ? R ? (R.input = p(R.input, H), R[0] = p(R[0], H), R.index = T.lastIndex, T.lastIndex += R[0].length) : T.lastIndex = 0 : y && R && (T.lastIndex = T.global ? R.index + R[0].length : k), b && R && R.length > 1 && n2(h, R[0], w, function() {
...
function Ih() {
  ...
  Mo = 1;
  var n2 = le(), e = Za();
  return n2({ target: "RegExp", proto: true, forced: /./.exec !== e }, {
    exec: e
  }), So;
}
var aa;
...
function qh() {
  if (Fo) return Bo;
  Fo = 1;
  var n2 = vl(), e = se(), r = re(), t = Ja(), i = ee(), a = ue(), s = te(), o = Je(), u = Lr(), l = nr(), h = qe(), c = Re(), v = en(), f = ar(), g = Mh(), d = rn(), p = ne(), y = p("replace"), m = Math.max, b = Math.min, x = r([].concat), S = r([].push), E = r("".indexOf), T = r("".slice), _ = function(w) {
  ...
  return t("replace", function(w, k, R) {
    ...
    return [
      ...
      function(U, I) {
        ...
        j || (I = h(I));
        var H = B.global, X;
        H && (X = B.unicode, B.lastIndex = 0);
        for (var $ = [], Q; Q = d(B, N), !(Q === null || (S($, Q), !H)); ) {
          var Fe = h(Q[0]);
...
function Vh() {
  if ($o) return Uo;
  $o = 1;
  var n2 = le(), e = jr(), r = qr().f, t = nr(), i = qe(), a = tn(), s = Re(), o = an(), u = Me(), l = e("".slice), h = Math.min, c = o("startsWith"), v = !u && !c && !!function() {
    var f = r(String.prototype, "startsWith");
    return f && !f.writable;
  }();
  return n2({ target: "String", proto: true, forced: !v && !c }, {
...
function Lh() {
  if (Wo) return ca;
  Wo = 1;
  var n2 = ne(), e = Fr(), r = $e().f, t = n2("unscopables"), i = Array.prototype;
...
function Sl() {
  if (Xo) return ga;
  Xo = 1;
  var n2 = we(), e = te(), r = _r(), t = Ha(), i = kh(), a = t("IE_PROTO"), s = Object, o = s.prototype;
...
function El() {
  if (Ko) return da;
  Ko = 1;
  var n2 = ee(), e = te(), r = Ce(), t = Fr(), i = Sl(), a = rr(), s = ne(), o = Me(), u = s("iterator"), l = false, h, c, v;
...
function Bh() {
  if (Qo) return pa;
  Qo = 1;
  var n2 = El().IteratorPrototype, e = Fr(), r = Ba(), t = Br(), i = mr(), a = function() {
    return this;
  };
...
function jh() {
  if (Zo) return ya;
  Zo = 1;
  var n2 = le(), e = se(), r = Me(), t = Dr(), i = te(), a = Bh(), s = Sl(), o = fl(), u = Br(), l = gr(), h = rr(), c = ne(), v = mr(), f = El(), g = t.PROPER, d = t.CONFIGURABLE, p = f.IteratorPrototype, y = f.BUGGY_SAFARI_ITERATORS, m = c("iterator"), b = "keys", x = "values", S = "entries", E = function() {
    return this;
  };
  return ya = function(T, _, V, P, M, w, k) {
    ...
    }, A = _ + " Iterator", U = false, I = T.prototype, B = I[m] || I["@@iterator"] || M && I[M], N = !y && B || R(M), L = _ === "Array" && I.entries || B, j, H, X;
    if (L && (j = s(L.call(new T())), j !== Object.prototype && j.next && (!r && s(j) !== p && (o ? o(j, p) : i(j[m]) || h(j, m, E)), u(j, A, true, true), r && (v[A] = E))), g && M === x && B && B.name !== x && (!r && d ? l(I, "name", x) : (U = true, N = function() {
      return e(B, this);
    })), M)
      if (H = {
        values: R(x),
      ...
      else n2({ target: _, proto: true, forced: y || U }, H);
...
var Jo;
function Fh() {
  return Jo || (Jo = 1, ma = function(n2, e) {
...
function Rl() {
  if (eu) return ba;
  eu = 1;
  var n2 = cr(), e = Lh(), r = mr(), t = Vr(), i = $e().f, a = jh(), s = Fh(), o = Me(), u = Ee(), l = "Array Iterator", h = t.set, c = t.getterFor(l);
  ba = a(Array, "Array", function(f, g) {
    ...
    if (!g || d >= g.length)
      return f.target = null, s(void 0, true);
    switch (f.kind) {
      case "keys":
        return s(d, false);
      case "values":
...
function zh() {
  if (au) return ru;
  au = 1;
  var n2 = Z(), e = Uh(), r = Gh(), t = Rl(), i = gr(), a = Br(), s = ne(), o = s("iterator"), u = t.values, l = function(c, v) {
    if (c) {
      if (c[o] !== u) try {
        i(c, o, u);
      } catch {
...
function Hh() {
  if (su) return Oa;
  su = 1;
  var n2 = je(), e = _r(), r = Zu(), t = Wa(), i = TypeError, a = "Reduce of empty array with no initial value", s = function(o) {
...
function $h() {
  if (uu) return nu;
  uu = 1;
  var n2 = le(), e = Hh().left, r = Cl(), t = ja(), i = kr(), a = !i && t > 79 && t < 83, s = a || !r("reduce");
  return n2({ target: "Array", proto: true, forced: s }, {
    reduce: function(u) {
...
function Wh() {
  if (hu) return lu;
  hu = 1;
  var n2 = le(), e = jr(), r = qr().f, t = nr(), i = qe(), a = tn(), s = Re(), o = an(), u = Me(), l = e("".slice), h = Math.min, c = o("endsWith"), v = !u && !c && !!function() {
...
function Yh() {
  if (cu) return fu;
  cu = 1;
  var n2 = se(), e = re(), r = Ja(), t = ue(), i = Je(), a = Re(), s = cl(), o = en(), u = nr(), l = qe(), h = ar(), c = rn(), v = Ol(), f = ee(), g = v.UNSUPPORTED_Y, d = 4294967295, p = Math.min, y = e([].push), m = e("".slice), b = !f(function() {
    var S = /(?:)/, E = S.exec;
    S.exec = function() {
...
function Qh() {
  ...
  gu = 1;
  for (var n2 = Kh(), e = typeof window > "u" ? kn : window, r = ["moz", "webkit"], t = "AnimationFrame", i = e["request" + t], a = e["cancel" + t] || e["cancelRequest" + t], s = 0; !i && s < r.length; s++)
  ...
  if (!i || !a) {
    ...
    i = function(c) {
      ...
      for (var v = 0; v < l.length; v++)
        l[v].handle === c && (l[v].cancelled = true);
    };
  }
...
function Jh() {
  if (yu) return Ca;
  yu = 1;
  var n2 = re(), e = Re(), r = qe(), t = wl(), i = n2("".replace), a = RegExp("^[" + t + "]+"), s = RegExp("(^|[^" + t + "])[" + t + "]+$"), o = function(u) {
    return function(l) {
      var h = r(e(l));
...
function rf() {
  if (bu) return du;
  bu = 1;
  var n2 = le(), e = Jh().trim, r = ef();
  return n2({ target: "String", proto: true, forced: r("trim") }, {
    trim: function() {
      return e(this);
    }
  }), du;
...
function nf() {
  if (Ou) return Tu;
  Ou = 1;
  var n2 = le(), e = jr(), r = ol().indexOf, t = Cl(), i = e([].indexOf), a = !!i && 1 / i([1], 1, -0) < 0, s = a || !t("indexOf");
  return n2({ target: "Array", proto: true, forced: s }, {
    indexOf: function(u) {
...
function sf() {
  ...
  return n2({ target: "String", proto: true, forced: !a("includes") }, {
    includes: function(u) {
      return !!~s(
        i(t(this)),
        i(r(u)),
...
function uf() {
  if (wu) return Ru;
  wu = 1;
  var n2 = le(), e = re(), r = of(), t = e([].reverse), i = [1, 2];
  return n2({ target: "Array", proto: true, forced: String(i) === String(i.reverse()) }, {
    reverse: function() {
...
function Al(n2, e) {
  ...
  Pl(n2, e), n2.prototype = e === null ? Object.create(e) : (r.prototype = e.prototype, new r());
}
function lf(n2) {
  var e = "";
...
function Ia(n2, e, r) {
  ...
  var o = Da([(e - a) / 2, (r - s) / 2], -n2.xRot / 180 * Ge), u = o[0], l = o[1], h = Math.pow(u, 2) / Math.pow(t, 2) + Math.pow(l, 2) / Math.pow(i, 2);
  1 < h && (t *= Math.sqrt(h), i *= Math.sqrt(h)), n2.rX = t, n2.rY = i;
  var c = Math.pow(t, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2), v = (n2.lArcFlag !== n2.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(t, 2) * Math.pow(i, 2) - c) / c)), f = t * l / i * v, g = -i * u / t * v, d = Da([f, g], n2.xRot / 180 * Ge);
  ...
  n2.ROUND = function(o) {
    ...
    return i(function(v, f, g, d, p) {
      ...
      if (v.type & O.SMOOTH_CURVE_TO && (b = isNaN(u) ? 0 : f - u, x = isNaN(l) ? 0 : g - l), v.type & (O.CURVE_TO | O.SMOOTH_CURVE_TO) ? (u = v.relative ? f + v.x2 : v.x2, l = v.relative ? g + v.y2 : v.y2) : (u = NaN, l = NaN), v.type & O.SMOOTH_QUAD_TO ? (h = isNaN(h) ? f : 2 * f - h, c = isNaN(c) ? g : 2 * g - c) : v.type & O.QUAD_TO ? (h = v.relative ? f + v.x1 : v.x1, c = v.relative ? g + v.y1 : v.y2) : (h = NaN, c = NaN), v.type & O.LINE_COMMANDS || v.type & O.ARC && (v.rX === 0 || v.rY === 0 || !v.lArcFlag) || v.type & O.CURVE_TO || v.type & O.SMOOTH_CURVE_TO || v.type & O.QUAD_TO || v.type & O.SMOOTH_QUAD_TO) {
        ...
        y(S) <= o && y(E) <= o && y(b) <= o && y(x) <= o && y(T) <= o && y(_) <= o && (m = true);
      }
    ...
    return i(function(o, u, l) {
      return O.ARC === o.type ? function(h, c, v) {
        ...
        for (var y = Math.min(h.phi1, h.phi2), m = Math.max(h.phi1, h.phi2) - y, b = Math.ceil(m / 90), x = new Array(b), S = c, E = v, T = 0; T < b; T++) {
          var _ = Au(h.phi1, h.phi2, T / b), V = Au(h.phi1, h.phi2, (T + 1) / b), P = V - _, M = 4 / 3 * Math.tan(P * Le / 4), w = [Math.cos(_ * Le) - M * Math.sin(_ * Le), Math.sin(_ * Le) + M * Math.cos(_ * Le)], k = w[0], R = w[1], A = [Math.cos(V * Le), Math.sin(V * Le)], U = A[0], I = A[1], B = [U + M * Math.sin(V * Le), I - M * Math.cos(V * Le)], N = B[0], L = B[1];
    ...
    var o = function(v) {
      ...
      if (d.type & O.ARC) {
        ...
        for (var E = d.xRot / 180 * Math.PI, T = Math.cos(E) * d.rX, _ = Math.sin(E) * d.rX, V = -Math.sin(E) * d.rY, P = Math.cos(E) * d.rY, M = d.phi1 < d.phi2 ? [d.phi1, d.phi2] : -180 > d.phi2 ? [d.phi2 + 360, d.phi1 + 360] : [d.phi2, d.phi1], w = M[0], k = M[1], R = function(L) {
          var j = L[0], H = L[1], X = 180 * Math.atan2(H, j) / Math.PI;
          return X < w ? X + 360 : X;
        }, A = 0, U = Pu(V, -T, 0).map(R); A < U.length; A++)
          (N = U[A]) > w && N < k && p(Iu(d.cX, T, V, N));
        for (var I = 0, B = Pu(P, -_, 0).map(R); I < B.length; I++) {
          var N;
          (N = B[I]) > w && N < k && y(Iu(d.cY, _, P, N));
        }
      }
      return v;
    });
...
var ff = function(n2) {
  ...
  return Al(e, n2), e.prototype.finish = function(r) {
    ...
    for (var a = function(c) {
      ...
      var o = r[s], u = !(this.curCommandType !== O.ARC || this.curArgs.length !== 3 && this.curArgs.length !== 4 || this.curNumber.length !== 1 || this.curNumber !== "0" && this.curNumber !== "1"), l = Mu(o) && (this.curNumber === "0" && o === "0" || u);
...
var O = function(n2) {
  ...
  return Al(e, n2), e.prototype.encode = function() {
...
var cf = ((Oe = {})[O.MOVE_TO] = 2, Oe[O.LINE_TO] = 2, Oe[O.HORIZ_LINE_TO] = 1, Oe[O.VERT_LINE_TO] = 1, Oe[O.CLOSE_PATH] = 0, Oe[O.QUAD_TO] = 4, Oe[O.SMOOTH_QUAD_TO] = 2, Oe[O.CURVE_TO] = 6, Oe[O.SMOOTH_CURVE_TO] = 4, Oe[O.ARC] = 7, Oe);
var qu = {};
var Na;
var Du;
function vf() {
...
function gf() {
  if (Vu) return qu;
  Vu = 1;
  var n2 = Dr().PROPER, e = rr(), r = ue(), t = qe(), i = ee(), a = vf(), s = "toString", o = RegExp.prototype, u = o[s], l = i(function() {
...
var yf = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
function mf(n2, e, r, t, i) {
  if (typeof n2 == "string" && (n2 = document.getElementById(n2)), !n2 || Pr(n2) !== "object" || !("getContext" in n2))
...
function bf(n2, e, r, t, i, a) {
  if (!(isNaN(a) || a < 1)) {
    a |= 0;
    var s = mf(n2, e, r, t, i);
    s = xf(s, e, r, t, i, a), n2.getContext("2d").putImageData(s, e, r);
  }
}
function xf(n2, e, r, t, i, a) {
  for (var s = n2.data, o = 2 * a + 1, u = t - 1, l = i - 1, h = a + 1, c = h * (h + 1) / 2, v = new Lu(), f = v, g, d = 1; d < o; d++)
  ...
  for (var p = null, y = null, m = 0, b = 0, x = pf[a], S = yf[a], E = 0; E < i; E++) {
    ...
    for (var w = 0, k = 0, R = 0, A = 0, U = h * T, I = h * _, B = h * V, N = h * P, L = c * T, j = c * _, H = c * V, X = c * P, $ = 1; $ < h; $++) {
      var Q = b + ((u < $ ? u : $) << 2), Fe = s[Q], De = s[Q + 1], Ae = s[Q + 2], de = s[Q + 3], pe = h - $;
      L += (f.r = Fe) * pe, j += (f.g = De) * pe, H += (f.b = Ae) * pe, X += (f.a = de) * pe, w += Fe, k += De, R += Ae, A += de, f = f.next;
    }
    p = v, y = g;
    for (var ye = 0; ye < t; ye++) {
      ...
      if (s[b + 3] = Ie, Ie !== 0) {
        var Ne = 255 / Ie;
        s[b] = (L * x >>> S) * Ne, s[b + 1] = (j * x >>> S) * Ne, s[b + 2] = (H * x >>> S) * Ne;
      } else
        s[b] = s[b + 1] = s[b + 2] = 0;
      L -= U, j -= I, H -= B, X -= N, U -= p.r, I -= p.g, B -= p.b, N -= p.a;
      var he = ye + a + 1;
      he = m + (he < u ? he : u) << 2, w += p.r = s[he], k += p.g = s[he + 1], R += p.b = s[he + 2], A += p.a = s[he + 3], L += w, j += k, H += R, X += A, p = p.next;
  ...
  for (var ve = 0; ve < t; ve++) {
    b = ve << 2;
    var fe = s[b], be = s[b + 1], C = s[b + 2], q = s[b + 3], G = h * fe, z = h * be, W = h * C, _e = h * q, Ve = c * fe, xe = c * be, Te = c * C, We = c * q;
    f = v;
    for (var ur = 0; ur < h; ur++)
      f.r = fe, f.g = be, f.b = C, f.a = q, f = f.next;
    for (var Or = t, $r = 0, Wr = 0, Yr = 0, Xr = 0, Sr = 1; Sr <= a; Sr++) {
      b = Or + ve << 2;
      var Er = h - Sr;
      Ve += (f.r = fe = s[b]) * Er, xe += (f.g = be = s[b + 1]) * Er, Te += (f.b = C = s[b + 2]) * Er, We += (f.a = q = s[b + 3]) * Er, Xr += fe, $r += be, Wr += C, Yr += q, f = f.next, Sr < l && (Or += t);
    }
    b = ve, p = v, y = g;
    for (var Kr = 0; Kr < i; Kr++) {
      var ce = b << 2;
      s[ce + 3] = q = We * x >>> S, q > 0 ? (q = 255 / q, s[ce] = (Ve * x >>> S) * q, s[ce + 1] = (xe * x >>> S) * q, s[ce + 2] = (Te * x >>> S) * q) : s[ce] = s[ce + 1] = s[ce + 2] = 0, Ve -= G, xe -= z, Te -= W, We -= _e, G -= p.r, z -= p.g, W -= p.b, _e -= p.a, ce = ve + ((ce = Kr + h) < l ? ce : l) * t << 2, Ve += Xr += p.r = s[ce], xe += $r += p.g = s[ce + 1], Te += Wr += p.b = s[ce + 2], We += Yr += p.a = s[ce + 3], p = p.next, G += fe = y.r, z += be = y.g, W += C = y.b, _e += q = y.a, Xr -= fe, $r -= be, Wr -= C, Yr -= q, y = y.next, b += t;
    }
  }
  return n2;
}
...
var Rf = /^[A-Z-]+$/;
function Cf(n2) {
  return Rf.test(n2) ? n2.toLowerCase() : n2;
}
function Nl(n2) {
  var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(n2) || [];
  return e[2] || e[3] || e[4];
...
var Af = /(#[^\s+>~.[:]+)/g;
var If = /(\.[^\s+>~.[:]+)/g;
var Nf = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi;
var _f = /(:[\w-]+\([^)]*\))/gi;
var Mf = /(:[^\s+>~.[:]+)/g;
var qf = /([^\s+>~.[:]+)/g;
function Ye(n2, e) {
...
function Va(n2, e) {
  return (n2[0] * e[0] + n2[1] * e[1]) / (ku(n2) * ku(e));
}
function Bu(n2, e) {
  return (n2[0] * e[1] < n2[1] * e[0] ? -1 : 1) * Math.acos(Va(n2, e));
}
function ju(n2) {
  return n2 * n2 * n2;
}
...
var D = class _D {
  ...
  split() {
    ...
    return sr(this.getString()).trim().split(e).map((i) => new _D(r, t, i));
  }
  hasValue(e) {
    var {
      value: r
  ...
  getColor(e) {
    ...
    return this.isNormalizedColor || (this.isNormalizedColor = true, r = wf(r), this.value = r), r;
  }
  getDpi() {
    return 96;
  }
  ...
  getTextBaseline() {
    return this.hasValue() ? _D.textBaselineMapping[this.getString()] : null;
  }
  addOpacity(e) {
    ...
    return new _D(this.document, this.name, r);
  }
};
...
var Ml = typeof fetch < "u" ? fetch.bind(void 0) : null;
var Ur = class {
  constructor(e) {
    var {
      fetch: r = Ml,
    ...
    this.ctx = e, this.FRAMERATE = 30, this.MAX_VIRTUAL_PIXELS = 3e4, this.CLIENT_WIDTH = 800, this.CLIENT_HEIGHT = 600, this.viewPort = new Vf(), this.mouse = new Lf(this), this.animations = [], this.waits = [], this.frameDuration = 0, this.isReadyLock = false, this.isFirstRender = true, this.intervalId = null, this.window = t, this.fetch = r;
  }
  wait(e) {
    this.waits.push(e);
  }
  ...
  shouldUpdate(e, r) {
    if (!e) {
      var {
        frameDuration: t
      } = this, i = this.animations.reduce((a, s) => s.update(t) || a, false);
      if (i)
        return true;
    }
...
var Bf = typeof DOMParser < "u" ? DOMParser : null;
var _a = class {
  constructor() {
    var {
      fetch: e = kf,
...
var Qe = class _Qe {
  constructor(e, r, t) {
    ...
    i.forEach((a) => {
      if (a !== "none") {
        var [s, o] = $f(a), u = _Qe.transformTypes[s];
  ...
  static fromElement(e, r) {
    ...
    return t.hasValue() ? new _Qe(e, t.getString(), s) : null;
  }
  apply(e) {
    for (var {
      transforms: r
...
var K = class _K {
  constructor(e, r) {
    ...
    if (this.document = e, this.node = r, this.captureTextNodes = t, this.attributes = {}, this.styles = {}, this.stylesSpecificity = {}, this.animationFrozen = false, this.animationFrozenValue = "", this.parent = null, this.children = [], !(!r || r.nodeType !== 1)) {
  ...
  addChild(e) {
    var r = e instanceof _K ? e : this.document.createElement(e);
    r.parent = this, _K.ignoreChildTypes.includes(r.type) || this.children.push(r);
  }
  matchesSelector(e) {
    var r, {
      node: t
...
function Xf(n2) {
  return typeof process > "u" ? n2 : n2.trim().split(",").map(Yf).join(",");
}
function Kf(n2) {
  if (!n2)
    return "";
...
var oe = class _oe {
  constructor(e, r, t, i, a, s) {
    var o = s ? typeof s == "string" ? _oe.parse(s) : s : {};
  ...
  static parse() {
    ...
    return u.forEach((h) => {
      switch (true) {
        case (!l.fontStyle && _oe.styles.includes(h)):
          h !== "inherit" && (t = h), l.fontStyle = true;
          break;
        case (!l.fontVariant && _oe.variants.includes(h)):
          h !== "inherit" && (i = h), l.fontStyle = true, l.fontVariant = true;
          break;
        case (!l.fontWeight && _oe.weights.includes(h)):
...
var tr = class extends K {
  ...
  setContext(e) {
    ...
    if (this.modifiedEmSizeStack = false, typeof e.font < "u") {
      var E = this.getStyle("font"), T = this.getStyle("font-style"), _ = this.getStyle("font-variant"), V = this.getStyle("font-weight"), P = this.getStyle("font-size"), M = this.getStyle("font-family"), w = new oe(T.getString(), _.getString(), V.getString(), P.hasValue() ? "".concat(P.getPixels(true), "px") : "", M.getString(), oe.parse(E.getString(), e.font));
      T.setValue(w.fontStyle), _.setValue(w.fontVariant), V.setValue(w.fontWeight), P.setValue(w.fontSize), M.setValue(w.fontFamily), e.font = w.toString(), P.isPixels() && (this.document.emSize = P.getPixels(), this.modifiedEmSizeStack = true);
    }
...
var Y = class _Y extends tr {
  ...
  pathA(e, r) {
    var {
      ...
      a1: h,
      ad: c
    } = _Y.pathA(t), v = 1 - o ? 1 : -1, f = h + v * (c / 2), g = new J(l.x + a * Math.cos(f), l.y + s * Math.sin(f));
  ...
  pathZ(e, r) {
    _Y.pathZ(this.pathParser), e && r.x1 !== r.x2 && r.y1 !== r.y2 && e.closePath();
  }
};
var Vl = class extends Y {
  constructor(e, r, t) {
...
var He = class _He extends tr {
  constructor(e, r, t) {
    super(e, r, new.target === _He ? true : t), this.type = "text", this.x = 0, this.y = 0, this.measureCache = -1;
  }
  setContext(e) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  ...
  getInheritedAttribute(e) {
    for (var r = this; r instanceof _He && r.isFirstChild(); ) {
...
var Gr = class _Gr extends He {
  constructor(e, r, t) {
    super(e, r, new.target === _Gr ? true : t), this.type = "tspan", this.text = this.children.length > 0 ? "" : this.getTextFromNode();
  }
  getText() {
    return this.text;
  }
};
var Zf = class extends Gr {
  constructor() {
    super(...arguments), this.type = "textNode";
  }
};
var br = class extends tr {
  constructor() {
  ...
  setContext(e) {
    ...
    f && (d = f[0], p = f[1]), this.root || (u = this.getStyle("width").getPixels("x"), l = this.getStyle("height").getPixels("y"), this.type === "marker" && (y = d, m = p, d = 0, p = 0)), i.viewPort.setCurrent(u, l), this.node && (!this.parent || ((r = this.node.parentNode) === null || r === void 0 ? void 0 : r.nodeName) === "foreignObject") && this.getStyle("transform", false, true).hasValue() && !this.getStyle("transform-origin", false, true).hasValue() && this.getStyle("transform-origin", true, true).setValue("50% 50%"), super.setContext(e), e.translate(this.getAttribute("x").getPixels("x"), this.getAttribute("y").getPixels("y")), f && (u = f[2], l = f[3]), t.setViewBox({
      ctx: e,
  ...
  resize(e) {
    ...
    if (t)
      if (typeof t == "string")
        this.getAttribute("preserveAspectRatio", true).setValue(t);
      else {
  ...
  update(e) {
    ...
    if (this.initialValue || (this.initialValue = t.getString(), this.initialUnits = t.getUnits()), this.duration > this.maxDuration) {
      ...
      if (this.getAttribute("repeatCount").getString() === "indefinite" || this.getAttribute("repeatDur").getString() === "indefinite")
        ...
        this.frozen = true, r.animationFrozen = true, r.animationFrozenValue = t.getString();
      else if (i === "remove" && !this.removed)
        return this.removed = true, t.setValue(r.animationFrozen ? r.animationFrozenValue : this.initialValue), true;
      return false;
    }
    this.duration += e;
    var a = false;
...
function Rr(n2) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? Wu(Object(r), true).forEach(function(t) {
      cP(n2, t, r[t]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n2, Object.getOwnPropertyDescriptors(r)) : Wu(Object(r)).forEach(function(t) {
      Object.defineProperty(n2, t, Object.getOwnPropertyDescriptor(r, t));
    });
  }
  return n2;
}
var pc = class extends He {
  constructor(e, r, t) {
  ...
  getPointOnCubicBezier(e, r, t, i, a, s, o, u, l) {
    var h = u * ju(e) + s * Fu(e) + i * Uu(e) + r * Gu(e), c = l * ju(e) + o * Fu(e) + a * Uu(e) + t * Gu(e);
    return {
      x: h,
      y: c
    };
...
jl.parseExternalUrl = Nl;
var Tc = class extends tr {
  constructor() {
...
var zr = class _zr extends K {
  ...
  apply(e, r) {
    ...
    var l = this.removeStyles(r, _zr.ignoreStyles), h = t.createCanvas(i + s, a + o), c = h.getContext("2d");
...
var Hr = class _Hr extends K {
  ...
  apply(e, r) {
    ...
    if (a) {
      ...
      if (!(h < 1 || c < 1)) {
        var v = Math.floor(a.x), f = Math.floor(a.y), g = this.removeStyles(r, _Hr.ignoreStyles), d = t.createCanvas(h, c), p = d.getContext("2d");
...
function Ic(n2) {
  for (var e = 1; e < arguments.length; e++) {
    var r = arguments[e] != null ? arguments[e] : {};
    e % 2 ? Xu(Object(r), true).forEach(function(t) {
      cP(n2, t, r[t]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n2, Object.getOwnPropertyDescriptors(r)) : Xu(Object(r)).forEach(function(t) {
      Object.defineProperty(n2, t, Object.getOwnPropertyDescriptor(r, t));
    });
  }
  return n2;
...
var ze = class _ze {
  constructor(e) {
    var {
      rootEmSize: r = 12,
      emSize: t = 12,
      createCanvas: i = _ze.createCanvas,
      createImage: a = _ze.createImage,
  ...
  createElement(e) {
    var r = e.nodeName.replace(/^[^:]+:/, ""), t = _ze.elementTypes[r];
...
var fr = class _fr {
  ...
  fork(e, r) {
    var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    return _fr.from(e, r, Xe(Xe({}, this.options), t));
  }
  /**
   * Create new Canvg instance with inherited options.
   * @param ctx - Rendering context.
  ...
  forkString(e, r) {
    var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    return _fr.fromString(e, r, Xe(Xe({}, this.options), t));
  }
  /**
...
@nomana-it/liberty-core/dist/index.es-D6oC0jBA.mjs:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-D6oC0jBA-TBWCFE5J.js.map
